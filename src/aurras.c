...
int main(int argc, char **argv) {
    //JOAO vai buscar o comando que esta no terminal vai mandar p servidor 
    //e espera que o servidor mande o nome do fifo que vamos comunicar e nesse 
    //fifo vai esperar pela informaçao do servidor
